...
namespace matchingGame
{
    public partial class Form1 : Form
    {
        ...
        private void TimerEvent(object sender, EventArgs e)
        {
            ...
            lblTime.Text = ": " + countDownTime;

            if (countDownTime < 1)
            {
                GameOver("O tempo acabou!! Perdeste!!");
        ...
        private void CheckPictures(PictureBox A, PictureBox B)
        {
            ...
            {
                GameOver("Bom trabalho, Ganhasteee !!");
            }
        }
        ...
        private void GameOver(string msg)
        {
            GameTimer.Stop();
            gameOver = true;
            MessageBox.Show(msg + "Carrega no botão,'Restart' para jogar outra vez!.");
        }
    }
}